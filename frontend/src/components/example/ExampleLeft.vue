    ...
    <div class="left-content">
      ...
      <div class="login-form">
        <b-form @submit.prevent="handleLogin">
          ...
          <b-form-group label="Password" label-for="password">
            <b-form-input
              ...
              class="dark-input"
            ></b-form-input>
          </b-form-group><b-button type="submit" variant="primary" class="login-btn">
            Login
          </b-button>
        </b-form>
        ...
        <div class="social-login">
          <b-button variant="outline-light" class="social-btn">
...
export default {
  ...
  methods: {
    handleLogin() {
      ...
      alert('Login effettuato con: ' + this.form.username);
      // this.$router.push('/dashboard'); // Esempio di reindirizzamento dopo il login
    }
  }
}
</script>
...
.example-left {
  background: linear-gradient(135deg, #090B10 0%, #16213e 100%);
  color: #F5F5F5;
  padding: 3rem 2rem;
  height: 100%;
  display: flex;
...
.left-content h2 {
  font-size: 2.5rem;
  margin-bottom: 1rem;
  font-weight: bold; /* Miedinger Bold */
   font-size: 1rem;
}
...
.left-content p {
  ...
  margin-bottom: 3rem;
  opacity: 0.9;
  font-weight: normal; /* Miedinger Light */
  font-size: 0.6rem;
}
.login-form {
...
.dark-input:focus {
  ...
  box-shadow: 0 0 0 0.25rem rgba(5, 155, 173, 0.25) !important;
  color: #F5F5F5 !important;
   font-size: 0.6rem;
}
...
.login-btn:hover {
  background-color: #04839e !important;
  border-color: #04839e !important;
